public class BinarySearch
{
    ...
    public static int recursiveBinarySearch(int[] intArray, int lowPosition, int highPosition, int target)
    {
        ...
        else
        {
            ...
            System.out.println(midPosition + " mid");
            System.out.println(lowPosition + " low");
            System.out.println(highPosition + " high");
            ...
            if (intArray[midPosition] < target)
            {
                ...
                return recursiveBinarySearch(intArray, lowPosition, highPosition, target);
            }
